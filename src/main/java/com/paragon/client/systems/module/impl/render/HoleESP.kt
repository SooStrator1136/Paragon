...
class HoleESP : Module("HoleESP", Category.RENDER, "Highlights holes to stand in when crystalling") {
    ...
    private var obsidian = Setting<Boolean?>("Obsidian", true)
    ...
    private var mixed = Setting<Boolean?>("Mixed", true)
    ...
    private var bedrock = Setting<Boolean?>("Bedrock", true)
    ...
    override fun onRender3D() {
        holes.forEach(Consumer { hole: Hole ->

...
object Keystrokes : HUDModule("Keystrokes", "Keystrokes duh?") {
    ...
    override fun render() {
        ...
        run {
            keyW.bounds.setRect(
                x + keySize.value + keyDistance.value,
                y,
                keySize.value,
                keySize.value
            )
            ...
            keyA.bounds.setRect(
                x,
                y + keySize.value + keyDistance.value,
                keySize.value,
                keySize.value
            )
            ...
            keyD.bounds.setRect(
                x + (keySize.value * 2F) + (keyDistance.value * 2F),
                y + keySize.value + keyDistance.value,
                keySize.value,
                keySize.value
            )
            ...
            keySpace.bounds.setRect(
                x,
                y + (keySize.value * 2F) + (keyDistance.value * 2F),
                (keySize.value * 3F) + (keyDistance.value * 2F),
                keySize.value
            )
        }
            ...
            if (animation.getAnimationFactor() > 0.0) {
                RenderUtil.drawCircle(
                    ...
                    Point2D.distance(
                        ...
                        bounds.x.toDouble(),
                        bounds.y.toDouble()
                    ) * animation.getAnimationFactor(),
                    circleColor.value.rgb
                )
            }

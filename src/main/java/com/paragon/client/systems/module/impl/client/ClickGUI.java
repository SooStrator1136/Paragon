...
public class ClickGUI extends Module {
    ...
    // GUI style
    public static ModeSetting<Style> style = new ModeSetting<>("Style", "The style of the ClickGUI", Style.PANEL);
    ...
    public static NumberSetting cornerRadius = (NumberSetting) new NumberSetting("Corner Radius", "The radius of the corners", 5, 1, 7, 1).setVisiblity(() -> style.getCurrentMode() == Style.PANEL).setParentSetting(style);

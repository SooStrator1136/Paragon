package com.paragon.client.systems.ui.panel.element.setting;
...
import com.paragon.client.systems.ui.window.impl.windows.components.settings.SliderComponent;
...
public class ColourElement extends Element {
    ...
    public void mouseClicked(int mouseX, int mouseY, Click click) {
        if (setting.isVisible()) {
            ...
            if (open) {
                getSubElements().forEach(subelement -> {
                    subelement.mouseClicked(mouseX, mouseY, click);
                });
            }
        }
    }
    ...
    public void mouseReleased(int mouseX, int mouseY, Click click) {
        if (setting.isVisible()) {
            getSubElements().forEach(subelement -> {
                subelement.mouseReleased(mouseX, mouseY, click);
            });

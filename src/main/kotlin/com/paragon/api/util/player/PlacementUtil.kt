...
object PlacementUtil : Wrapper {
    ...
    private fun BlockPos.getVisibleSides(): List<EnumFacing> {
        ...
        val facing = Vec3d(
            minecraft.player.getPositionEyes(minecraft.renderPartialTicks).x - center.x,
            minecraft.player.getPositionEyes(minecraft.renderPartialTicks).y - center.y,
            minecraft.player.getPositionEyes(minecraft.renderPartialTicks).z - center.z
        )

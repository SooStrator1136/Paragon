...
class ParagonMenu : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        RenderUtil.drawRoundedRect(
            (width / 2f - 110).toDouble(), (height / 2f - 50).toDouble(), 220.0, 130.0, 5.0, 5.0, 5.0, 5.0, -0x80000000
        )
        ...
        run {
            ...
            FontUtil.renderCenteredString(
                "Paragon", width / 2f * scaleFactor, (height / 2f - 30) * scaleFactor, Colours.mainColour.value.rgb, true
            )
        ...
        run {
            ...
            FontUtil.renderCenteredString(
                "v" + Paragon.modVersion, width / 2f * scaleFactor, (height / 2f - 10) * scaleFactor, 0xFFFFFF, true
            )
            glScalef(scaleFactor, scaleFactor, scaleFactor)
        }
        ...
        // Rect
        RenderUtil.drawRoundedRect(
            5.0, 250.0, 200 * creditsAnimation.getAnimationFactor(), 60.0, 5.0, 5.0, 5.0, 5.0, -0x80000000
        )
        ...
        run {
            ...
            var y = 270f
            for (str in arrayOf(
                "Created by Surge & Teletofu", "Shader OpenGL code - linustouchtips", "Font Renderer - Cosmos Client"
            )) {

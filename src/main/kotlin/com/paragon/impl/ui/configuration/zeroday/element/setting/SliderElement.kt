...
class SliderElement(
    layer: Int, setting: Setting<Number>, moduleElement: ModuleElement, x: Float, y: Float, width: Float, height: Float
    ...
    override fun render(mouseX: Int, mouseY: Int, dWheel: Int) {
        if (setting.isVisible()) {
            ...
            drawRect(
                x + layer, y, renderWidth, height, Color.HSBtoRGB(parent.leftHue / 360, 1f, (0.5f + 0.25f * hover.getAnimationFactor()).toFloat())
            )
            ...
            drawStringWithShadow(
                setting.value.toString(), (x + totalWidth) - getStringWidth(setting.value.toString()) - 10, y + height / 2 - 3.5f, -0x1
            )

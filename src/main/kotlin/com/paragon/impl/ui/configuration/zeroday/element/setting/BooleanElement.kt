...
class BooleanElement(
    layer: Int, setting: Setting<Boolean>, moduleElement: ModuleElement, x: Float, y: Float, width: Float, height: Float
    ...
    override fun render(mouseX: Int, mouseY: Int, dWheel: Int) {
        if (setting.isVisible()) {
            ...
            drawRect(
                x + layer, y, 1f, (height * enabledAnimation.getAnimationFactor()).toFloat(), Color.HSBtoRGB(parent.leftHue / 360, 1f, (0.5f + 0.25f * hover.getAnimationFactor()).toFloat())
            )

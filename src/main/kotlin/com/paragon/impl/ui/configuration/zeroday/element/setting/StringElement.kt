...
class StringElement(
    layer: Int, setting: Setting<String>, moduleElement: ModuleElement, x: Float, y: Float, width: Float, height: Float
        ...
        if (setting.isVisible()) {
            ...
            run {
                ...
                drawStringWithShadow(
                    TextFormatting.GRAY.toString() + " " + this.setting.value + if (focused) "_" else "", side, (y + 5f) * scaleFactor, -1
                )
            }

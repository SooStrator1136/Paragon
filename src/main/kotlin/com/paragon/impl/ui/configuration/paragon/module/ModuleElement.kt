package com.paragon.impl.ui.configuration.paragon.module
...
import com.paragon.impl.ui.configuration.paragon.setting.impl.*
...
class ModuleElement(val module: Module, val panel: CategoryPanel, x: Float, y: Float, width: Float, height: Float) : RawElement(x, y, width, height) {
    ...
    override fun isHovered(mouseX: Float, mouseY: Float): Boolean {
        return super.isHovered(mouseX, mouseY) && mouseY > panel.y + panel.height && mouseY < panel.y + panel.height + 320.0
    }

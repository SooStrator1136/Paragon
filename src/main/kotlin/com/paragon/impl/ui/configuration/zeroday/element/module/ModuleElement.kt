package com.paragon.impl.ui.configuration.zeroday.element.module
...
import com.paragon.impl.ui.configuration.zeroday.panel.CategoryPanel
...
class ModuleElement(parent: CategoryPanel, module: Module, x: Float, y: Float, width: Float, height: Float) : Element(0, x, y, width, height) {
    ...
    override fun render(mouseX: Int, mouseY: Int, dWheel: Int) {
        ...
        drawRect(
            x, y, (width * enabledAnimation.getAnimationFactor()).toFloat(), height, Color(
                Color.HSBtoRGB(
                    parent!!.leftHue / 360, 1f, (0.75f + 0.25f * hover.getAnimationFactor()).toFloat()
                )
            ).rgb
        )

...
class EnumElement(
    layer: Int, setting: Setting<Enum<*>>, moduleElement: ModuleElement, x: Float, y: Float, width: Float, height: Float
    ...
    override fun render(mouseX: Int, mouseY: Int, dWheel: Int) {
        if (setting.isVisible()) {
            ...
            drawStringWithShadow(
                getFormattedText(setting.value), x + maxTextWidth, y + height / 2 - 3.5f, -0x1
            )

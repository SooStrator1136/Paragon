...
object Taskbar : Wrapper {
    ...
    fun draw(mouseX: Int, mouseY: Int) {
        ...
        RenderUtil.drawRect(
            0f,
            scaledResolution.scaledHeight - (26f * expandAnimation.getAnimationFactor().toFloat()),
        ...
        RenderUtil.drawRect(
            150f,
            scaledResolution.scaledHeight - (26f * expandAnimation.getAnimationFactor().toFloat()) - 2,
            scaledResolution.scaledWidth.toFloat() - 150f,
            2f,
        ...
        if (tooltip != "") {
            ...
            FontUtil.drawStringWithShadow(
                ...
                scaledResolution.scaledHeight - 14f,
                Color.WHITE.rgb
            )
        }
    }
